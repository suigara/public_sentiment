...
EOD;
	 ...
	 * <li>encode: boolean, specifies whether to encode HTML-encode tag attributes and values. Defaults to true.</li>
	 * </ul>
	 * A special option named 'uncheckValue' is available that can be used to specify the value
	 ...
	 * This option defaults to 'primaryKey', meaning using the 'primaryKey' property value of the objects in the selection.</li>
	 * </ul>
	 ...
	 * <li>live: boolean, whether the event handler should be attached with live/delegate or direct style. If not set, {@link liveEvents} will be used.</li>
	 * </ul>
	 */
	protected static function clientChange($event,&$htmlOptions)
	{
		...
		if($live)
			$cs->registerScript('Mod.CHtml.#' . $id, "$('body').on('$event','#$id',function(){{$handler}});");
		else
			$cs->registerScript('Mod.CHtml.#' . $id, "$('#$id').on('$event', function(){{$handler}});");
