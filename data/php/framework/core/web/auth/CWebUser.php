...
class CWebUser extends CApplicationComponent implements IWebUser
{
		...
		if($this->beforeLogin($id,$states,false))
		{
			...
			if($duration>0)
			{
				if($this->allowAutoLogin)
					...
					throw new CException(Mod::t('yii','{class}.allowAutoLogin must be set true in order to use cookie-based authentication.',
	...
	public function loginRequired()
	{
		...
		if(($url=$this->loginUrl)!==null)
		{
			...
			throw new CHttpException(403,Mod::t('yii','Login Required'));
	}
	...
	public function getStateKeyPrefix()
	{
		if($this->_keyPrefix!==null)
			...
			return $this->_keyPrefix=md5('Yii.'.get_class($this).'.'.Mod::app()->getId());
	}
