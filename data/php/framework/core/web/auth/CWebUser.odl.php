...
class CWebUser extends CApplicationComponent implements IWebUser
{
	...
	{
		return $this->getState('__returnUrl', $defaultUrl===null ? Mod::app()->getRequest()->getScriptUrl() : CHtml::normalizeUrl($defaultUrl));
	}
	...
	{
		Mod::app()->getSession()->regenerateID();
		$this->setId($id);
		$this->setName($name);
	...
	public function checkAccess($operation,$params=array(),$allowCaching=true)
	{
		if($allowCaching && $params===array() && isset($this->_access[$operation]))
			...
			return $this->_access[$operation]=Mod::app()->getAuthManager()->checkAccess($operation,$this->getId(),$params);
	}
}
