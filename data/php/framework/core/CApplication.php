...
abstract class CApplication extends CModule
{
	...
	{
		if($this->hasEventHandler('onEndRequest'))
			$this->onEndRequest(new CEvent($this, array('status'=>$status)));
		if($exit)
			exit($status);
	}
	...
	{
		return CLocale::$dataPath===null ? Mod::getPathOfAlias('system.i18n.data') : CLocale::$dataPath;
	}
	...
	protected function registerCoreComponents()
	{
		$components=array(
			'coreMessages'=>array(
				...
				'language'=>'en_us',
				'basePath'=>MOD_PATH.DIRECTORY_SEPARATOR.'exts'.DIRECTORY_SEPARATOR.'messages',
			),
			'db'=>array(
				'class'=>'CDbConnection',
			),
