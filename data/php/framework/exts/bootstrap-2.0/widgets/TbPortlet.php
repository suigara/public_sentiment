...
class TbPortlet extends CWidget
{
	...
	protected function renderDecoration()
	{
		if($this->title!==null)
		{
			echo "<ul class=\"{$this->decorationCssClass}\">\n";
			echo "<li class=\"{$this->titleCssClass}\">{$this->title}</li>\n";
			echo "<li class=\"{$this->dividerCssClass}\"></li>\n";
		}
	}
